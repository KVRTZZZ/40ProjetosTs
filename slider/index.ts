...
const autor = document.getElementById("author") as HTMLElement;
const trabalho = document.getElementById("job") as HTMLElement;
const info = document.getElementById("info") as HTMLElement;

const voltar = document.querySelector(".prev-btn") as HTMLButtonElement;
const proximo = document.querySelector(".next-btn") as HTMLButtonElement;
const aleatorio = document.querySelector(".random-btn")as HTMLButtonElement;

let itemAtual: number = 0
...
function showPessoas(pessoa: number) {
